...
export default function CompanyChart({ data, isLoading }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={240}>
      <BarChart data={data} margin={{ left: 0, right: 10, top: 4, bottom: 4 }}>
        ...
        <XAxis dataKey="Company Code" tick={{ fill: '#94a3b8', fontSize: 12 }} axisLine={false} tickLine={false} />
        <YAxis tickFormatter={v => formatINR(v)} tick={{ fill: '#64748b', fontSize: 11 }} axisLine={false} tickLine={false} width={70} />
        <Tooltip content={<CustomTooltip formatter={v => formatINR(v)} />} cursor={{ fill: 'rgba(99,102,241,0.08)' }} />
        <Bar dataKey="Total_Spend_INR" name="Spend INR" radius={[6, 6, 0, 0]} maxBarSize={48}>
